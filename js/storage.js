...
const SAMPLE_LOGS = [
  { date: "2026-06-18", subject: "Math", hours: 2 },
  { date: "2026-06-19", subject: "Physics", hours: 1.5 },
  { date: "2026-06-20", subject: "Chemistry", hours: 2.5 },
  { date: "2026-06-21", subject: "Math", hours: 1 },
  { date: "2026-06-22", subject: "Physics", hours: 2 },
  { date: "2026-06-23", subject: "Chemistry", hours: 1.5 },
...
const BADGES = [
  ...
  { id: "week-warrior", name: "Week Warrior", xpRequired: 100 },
...
function addXP(amount) {
  ...
  if (data.gamification.lastStudyDate) {
    const last = new Date(data.gamification.lastStudyDate);
...
function getExamCountdown(examDate) {
  ...
  const diff = Math.ceil((new Date(examDate) - Date.now()) / (1000 * 60 * 60 * 24));
